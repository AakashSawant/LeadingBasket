		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="media-container-column col-lg-8"
					...
					<form class="mbr-form" name=conv data-form-title="">
						<div class="row row-sm-offset">
							<div class="col-md-4 multi-horizontal" data-for="inch">
								<div class="form-group">
									<label class="form-control-label mbr-fonts-style display-7"
										for="name-form1-2">Inch</label>
										 <input class="form-control"
										 onkeyUp="checnum(this);inchconv();" value=1 name=inch
										data-form-field="inch" id="name-form1-2">
								</div>
							</div>
							<div class="col-md-4 multi-horizontal" data-for="cm">
								<div class="form-group">
									<label class="form-control-label mbr-fonts-style display-7"
										for="name-form1-2">CM</label>
										 <input class="form-control"
										 onkeyUp="checnum(this);cmconv();" value=2.25 name=cm
										data-form-field="cm" id="name-form1-2">
								</div>
							</div><div class="col-md-4 multi-horizontal" data-for="feet">
								<div class="form-group">
									<label class="form-control-label mbr-fonts-style display-7"
										for="name-form1-2">FEET</label>
										 <input class="form-control"
										 onkeyUp="checnum(this);feetconv();" value=0 name=feet
										data-form-field="feet" id="name-form1-2">
								</div>
							</div><div class="col-md-6 multi-horizontal" data-for="kilo">
								<div class="form-group">
									<label class="form-control-label mbr-fonts-style display-7"
										for="name-form1-2">KM</label>
										 <input class="form-control"
										 onkeyUp="checnum(this);kiloconv();" value=0 name=kilo 
										data-form-field="kilo" id="name-form1-2">
								</div>
							</div><div class="col-md-6 multi-horizontal" data-for="miles">
								<div class="form-group">
									<label class="form-control-label mbr-fonts-style display-7"
										for="name-form1-2">Inch</label>
										 <input class="form-control"
										 onkeyUp="checnum(this);milesconv();" value=0 name=miles
										data-form-field="miles" id="name-form1-2">
								</div>
							</div>
						</div>
					</form>
