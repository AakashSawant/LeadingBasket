...
<head>
    ...
    <link href="<c:url value='docstyle/bootstrap.css' />" rel="stylesheet"></link>
      <link href="<c:url value='docstyle/app.css' />" rel="stylesheet"></link>
                ...
                <form method="POST" role="form" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input type="file" name="file" id="file"  accept="application/pdf,images/*.doc,.docx" class="form-control input-sm"/>
                                <div class="has-error">
