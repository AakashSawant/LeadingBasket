							...
							<div id="collapse1_5" class="panel-collapse noScroll collapse "
								...
								<div class="panel-body p-4 mbr-fonts-style panel-text display-7">
									...
									<ul type="square">
										...
										<li>Applicant and Co Applicant
											<ul type="disc">
												<li>4 Passport size Photographs</li>
												<li>Pan Card</li>
												<li>Residence Address Proof (Any two)
													<ol>
														<li>Aadhaar Card</li>
														<li>Election Card</li>
														...
														<li>Rent Aggreement</li>
													</ol>
												</li>
												<li>Income Tax Return (Last 3 Year)</li>
												<li>Salary Slip (Last 6 Months)</li>
												<li>Form 16 (Last 3 Years)</li>
												<li>Appointment Letter of Company</li>
												<li>Identity card of Company</li>
												<li>All Bank Statements (Last 12 Month)</li>
												<li>All Loan Statements with Sanction Letter (If Any)</li>
											</ul>
										</li>
										<li>Property Documents
											<ol>
												<li>Copy Of Registry</li>
												<li>Last vera bill and its receipts</li>
												<li>Master File Of Property</li>
											</ol>
										</li>
									</ul>
									...
									<ul type="square">
										...
										<li>Applicant and Co Applicant
											<ul type="disc">
												...
												<li>Office Address Proof (Any One)
													<ol>
														<li>Election Card</li>
														<li>Telephone Bill</li>
														<li>Rent Agreement</li>
												...
												<li>Rent Agreement -Proposed Factory</li>
												<li>Business Proof (Any One)
													<ol>
														<li>Udhyog Adhaar</li>
														<li>SSI Certificate</li>
														<li>Gumastadhara License</li>
													</ol>
												</li>
												<li>Income Tax Return of all Directors &amp; Company
													(last 3 years)
													<ol>
														...
														<li>Capital A/c</li>
														<li>Balance Sheet</li>
														<li>Audit Report (if applicable)</li>
													</ol>
												</li>
												<li>Pan Card of the Company</li>
												<li>Memorandum of Association</li>
												<li>Article of Association</li>
												<li>Share Holding Pattern on letter head of Company</li>
												<li>All Bank Statements of all Directors & Company -
													Current & Saving Account (last 12 months)</li>
												<li>All Loan Statements with Sanction Letters of all
													Directors & Company (if any)</li>
											</ul>
										</li>
										<li>Property Documents
											<ol>
												<li>Copy Of Registry</li>
												<li>Latest vera bill and its receipts</li>
												<li>Master File Of Property</li>
											</ol>
										</li>
									</ul>
			...
			<div class="row">
				<div class="mbr-white col-lg-8 col-md-7 content-container">
					<h1
						...
						INTRO WITH FORM</h1>
					<p class="mbr-text pb-3 mbr-fonts-style display-5">Click any
						text to edit or style it. Select text to insert a link. Click blue
						"Gear" icon in the top right corner to hide/show text, title and
						change the block or form background. Click red "+" in the bottom
						right corner to add a new block. Use the top left menu to create
						new pages, sites and add themes.</p>
				</div>
								...
								<div data-for="name">
									<div class="form-group">
										<input type="text" class="form-control px-3" name="name"
											data-form-field="Name" placeholder="Name*" required="required"
											id="name-header15-c">
									</div>
								</div>
								<div data-for="email">
