			...
			<div class="media-container-row">
				<div class="title col-12 col-md-8">
					...
					<h3
						...
						<h4 class="mbr-section-subtitle align-center mbr-light mbr-white pb-3 mbr-fonts-style display-4">We offer a wide range of loan products to suit all your requirements ranging from home, mortgage & auto loans for individuals and families to business, machinery and project loans for businesses and corporations.</h4>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="media-container-row">
				...
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					...
					<div class="card-box">
							...
							<a href="Homeloan" class="link text-black">Home Loan</a>
						</h4>
					</div>
				</div>
				...
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					...
					<div class="card-box">
						<h4 class="card-title py-3 mbr-fonts-style display-5">
							<a href="/MortgageLoan" class="link text-black">Mortgage Loan</a>
						</h4>
					</div>
				</div>
				...
				<div class="card p-3 col-12 col-md-6 col-lg-4">
					...
					<div class="card-box">
							<h4 class="card-title py-3 mbr-fonts-style display-5">
							<a href="/carLoan" class="link text-black">Car Loan</a>
						</h4>					</div>
				</div>
			</div>
